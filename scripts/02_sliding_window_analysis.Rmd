...
yeardf1$minse<-yearfit1$fit-1.96*(yearfit1$se.fit)
yeardf1$maxse<-yearfit1$fit+1.96*(yearfit1$se.fit)
...
#add variables for 95% confidence intervals 
fptplotdf$minse<-fptfit$fit-1.96*(fptfit$se.fit)
fptplotdf$maxse<-fptfit$fit+1.96*(fptfit$se.fit)
